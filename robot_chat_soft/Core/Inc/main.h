...
#define BTN_GAME_STATUS_Pin GPIO_PIN_13
#define BTN_GAME_STATUS_GPIO_Port GPIOC
#define BTN_GAME_STATUS_EXTI_IRQn EXTI4_15_IRQn
#define BTN_GAME_START_Pin GPIO_PIN_14
#define BTN_GAME_START_GPIO_Port GPIOC
#define BTN_GAME_START_EXTI_IRQn EXTI4_15_IRQn
#define BUMP_EXTI_Pin GPIO_PIN_0
#define BUMP_EXTI_GPIO_Port GPIOC
#define BUMP_EXTI_EXTI_IRQn EXTI0_1_IRQn
#define FBD_EXTI_Pin GPIO_PIN_1
#define FBD_EXTI_GPIO_Port GPIOC
#define FBD_EXTI_EXTI_IRQn EXTI0_1_IRQn
#define BBD_EXTI_Pin GPIO_PIN_2
#define BBD_EXTI_GPIO_Port GPIOC
#define BBD_EXTI_EXTI_IRQn EXTI2_3_IRQn
...
#define IMU_INT1_EXTI_IRQn EXTI2_3_IRQn
#define IMU_INT2_Pin GPIO_PIN_4
#define IMU_INT2_GPIO_Port GPIOD
#define IMU_INT2_EXTI_IRQn EXTI4_15_IRQn
#define IMU_SPI_SDO_Pin GPIO_PIN_5
#define IMU_SPI_SDO_GPIO_Port GPIOD
#define IMU_SPI_SDI_Pin GPIO_PIN_6
