...
//Constantes en masque "|" pour préciser le type de message envoyé
...
int IMU_init(h_imu_drv_t * h_imu){
	...
	// Lecture du registre Who Am I pour vérifier que l'IMU est joignable
	receive_buffer = 0;
	transmit_buffer = 0xF;
...
// Lit les reistres de vitesse de rotation un par un
...
//Lit les registres de vitesse de rotation 2 par 2
