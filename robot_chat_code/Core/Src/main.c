...
int main(void)
{
  ...
  /* USER CODE BEGIN 2 */
	...
	current_sense_start();
	motor_init(&Rmot, &htim14, &htim17, &htim3, 1, 2000<<16, 4000<<16, 0, 1024<<16, 10, 0, 0, 0, 0);
